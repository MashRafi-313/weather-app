...
class AppContent extends StatelessWidget {
  ...
  final Function() toggleMode;
   ...
   final currentIndex;
  AppContent({super.key, required this.toggleMode, required this.updateIndex, this.currentIndex, this.weatherDataInfo});

  @override
  Widget build(BuildContext context) {

    WeatherData weatherData =
    weatherDataInfo!.weatherData![currentIndex];
    return SafeArea(
